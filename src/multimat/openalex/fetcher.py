...
def fetch(
    ...
    FetchResult
        ...
        :func:`~multimat.preprocess.pipeline.filter_by_publisher`.

    Examples
    --------
    >>> from multimat.openalex.fetcher import fetch
    ...
    headers: dict[str, str] = {"User-Agent": "multimat/1.0"}
    if email:
